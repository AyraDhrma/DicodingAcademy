package com.ayra.academy.utils;
...
public class DataDummy {
    ...
    public static ArrayList<CourseEntity> generateDummyCourse() {
        ArrayList<CourseEntity> courseEntityArrayList = new ArrayList<>();

        courseEntityArrayList.add(new CourseEntity("a14",
        ...
        courseEntityArrayList.add(new CourseEntity("a55",
        ...
        courseEntityArrayList.add(new CourseEntity("a47",
        ...
        courseEntityArrayList.add(new CourseEntity("a74",
        ...
        courseEntityArrayList.add(new CourseEntity("a51",
    ...
    public static ArrayList<ModuleEntity> generateDummyModule(String courseId) {
        ArrayList<ModuleEntity> moduleEntityArrayList = new ArrayList<>();

        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm1", courseId),
                courseId,
                "Modul 0 : Introduction",
                0,
                null));
        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm2", courseId),
                courseId,
                "Modul 1 : Teori 1",
                1,
                null));
        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm3", courseId),
                courseId,
                "Latihan 1",
                2,
                null));
        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm4", courseId),
                courseId,
                "Bedah Kode 1",
                3,
                null));
        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm5", courseId),
                courseId,
                "Modul 2 : Teori 2",
                4,
                null));

        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm6", courseId),
                courseId,
                "Latihan 2",
                5,
                null));

        moduleEntityArrayList.add(new ModuleEntity(String.format("%sm7", courseId),
                courseId,
                "Bedah Kode 2",
                6,
                null));
        ...
        return moduleEntityArrayList;
    }

    public static CourseEntity getCourse(String courseId) {
        for (int i = 0; i < generateDummyCourse().size(); i++) {
            CourseEntity entity = generateDummyCourse().get(i);
